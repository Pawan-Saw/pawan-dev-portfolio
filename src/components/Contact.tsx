...
const Contact: React.FC = () => {
  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      value: "pksaw7717@gmail.com",
      link: "mailto:pksaw7717@gmail.com"
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/Pawan-Saw",
      icon: (
    ...
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/pawan-kumar-21a794310",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
