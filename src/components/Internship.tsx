...
const Internship: React.FC = () => {
  ...
  const getCompanyColor = (company: string) => {
    if (company.includes("Deloitte")) return "from-blue-600 to-blue-700";
    if (company.includes("ARDENT")) return "from-purple-600 to-purple-700";
    return "from-gray-600 to-gray-700";
  };

  const getCompanyBgColor = (company: string) => {
    if (company.includes("Deloitte")) return "bg-blue-50";
    if (company.includes("ARDENT")) return "bg-purple-50";
    return "bg-gray-50";
  };

  return (
    <section id="internship" className="py-20 bg-white dark:bg-gray-950">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-6">
              My <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Internships</span>
            </h2>
          ...
          <div className="space-y-12">
            {internships.map((internship) => (
              <div
                key={internship.id}
                className={`${getCompanyBgColor(internship.company)} dark:bg-opacity-20 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300`}
              >
                <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  <div className="lg:col-span-1">
                    <div className="flex items-center space-x-4 mb-6">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{internship.company}</h3>
                        <p className="text-gray-600 dark:text-gray-300 font-medium">{internship.position}</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-gray-700 dark:text-gray-300">{internship.type}</span>
                      </div>
                      {internship.credentialId && (
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="text-gray-700 dark:text-gray-300">ID: {internship.credentialId}</span>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="lg:col-span-2">
                    <div className="mb-6">
                      ...
                      <div className="mb-6">
                        <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Technologies & Skills:</h4>
                        <div className="flex flex-wrap gap-2">
                          {internship.skills.map((skill, index) => (
                            <span
                              key={index}
                              className={`px-3 py-1 bg-gradient-to-r ${getCompanyColor(internship.company)} text-white rounded-full text-sm font-medium`}
                            >
                              {skill}
                            </span>
                          ))}
                      ...
                      {internship.certificate && (
                        <div className="flex items-center space-x-4">
                          <a
                            ...
                            className="flex items-center space-x-2 px-4 py-2 bg-white dark:bg-gray-900 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300"
                          >
                            <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            <span className="text-gray-700 dark:text-gray-300 font-medium">View Certificate</span>
                          </a>
                          {internship.platform && (
